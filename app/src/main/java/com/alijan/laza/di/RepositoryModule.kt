...
object RepositoryModule {
    ...
    @Singleton
    @Provides
    fun provideAuthRepository(firebaseAuth: FirebaseAuth, dataStore: LocalDataSource): AuthRepository {
        return AuthRepositoryImpl(firebaseAuth, dataStore)
    }

    @Singleton
    @Provides
    fun provideProductRepository(remoteDataSource: RemoteDataSource, localDataSource: LocalDataSource): ProductRepository {
